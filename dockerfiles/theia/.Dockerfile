...
# Builder Image
#
FROM eclipse/che-theia-dev:nightly as builder
WORKDIR ${HOME}
...
#invalidate cashe
ADD https://${GITHUB_TOKEN}:x-oauth-basic@api.github.com/repos/theia-ide/theia/git/refs/heads/master /tmp/branch_info.json

# Clone theia
RUN git clone --branch master  --single-branch --depth 1 https://github.com/theia-ide/theia ${HOME}/theia-source-code
