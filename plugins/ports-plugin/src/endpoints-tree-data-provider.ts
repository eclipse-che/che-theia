...
export type EndpointTreeNodeItemContext = 'publicHttpsEndpointOnline' | 'publicHttpEndpointOnline' | 'publicHttpPortOnline' | 'publicPortOnline' | 'publicDevfilePortOffline'
