...
import { Container, Pod, Metrics, MetricContainer } from './objects';
...
class ResMon {
    ...
    private updateStatusBar(): void {
        ...
        const memoryValue = `$(ellipsis) Mem: ${(memUsed / Units.G).toFixed(2)}/${(memTotal / Units.G).toFixed(2)} GB ${Math.floor(memUsed / memTotal * 100)}%`;
